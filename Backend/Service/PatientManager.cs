...
namespace Backend.Service
{
    public class PatientManager
    {
        ...
        public IEnumerable<Patient> getAllPatients()
        {
            ...
            {
                Patient carlos = new Patient("Carlos", "Martínez", "CC", "1", "3006009000", "carlos.martinez@hotmail.com", new DateTime(2000, 7, 15), "Colombia", "Medellín");
                carlos.creationDate = DateTime.Parse("2019-07-11");
                Patient camila = new Patient("Camila", "Pérez", "CC", "2", "3006008000", "camila.perez@gmail.com", new DateTime(1998, 11, 5), "Colombia", "Cali");
                camila.creationDate = DateTime.Parse("2007-01-21");
                Patient john = new Patient("John", "Dale", "CE", "3", "170039933", "john.dale@yahoo.com", new DateTime(1990, 1, 30), "Estados Unidos", "Utah");
                john.creationDate = DateTime.Parse("2017-05-17");
                patientRepository.Add(carlos);
                patientRepository.Add(camila);
                patientRepository.Add(john);
            }
